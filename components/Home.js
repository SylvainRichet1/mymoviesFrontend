...
function Home() {
  ...
  useEffect(()=>{
    fetch("https://mymovies-backend-jn58.vercel.app/movies")
  ...
  const movies = moviesData.map((data, i) => {
    ...
    console.log(data)
    return <Movie key={i} updateLikedMovies={updateLikedMovies} isLiked={isLiked} title={data.title} overview={data.overview} poster={data.poster_path} vote_average={data.vote_average} vote_count={data.vote_count} />;
  });
